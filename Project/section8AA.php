...
<div class ="container">
  <main id="tournament">
  	<ul class="round round-1">
  		...
  		<li class="game game-top winner"><button class="btn btn-primary btn-md round1 slot1" value="1" style="width:200px; background-color: black"><?php echo $section8->getFirst();?></button> <span></span></li>
  		<li class="game game-spacer">&nbsp;</li>
  		<li class="game game-bottom winner"><button class="btn btn-primary btn-md round1 slot2" value="2" style="width:200px; background-color: black"><?php echo $section8->getEighth();?></button> <span></span></li>

  		<li class="spacer">&nbsp;</li>
  		<li class="spacer">&nbsp;</li>

  		<li class="game game-top winner"><button class="btn btn-primary btn-md round1 slot3" value="3" style="width:200px; background-color: black"><?php echo $section8->getFourth();?></button><span></span></li>
  		<li class="game game-spacer">&nbsp;</li>
  		<li class="game game-bottom winner"><button class="btn btn-primary btn-md round1 slot4" value="4" style="width:200px; background-color: black"><?php echo $section8->getFifth();?></button> <span></span></li>

  		<li class="spacer">&nbsp;</li>
  		<li class="spacer">&nbsp;</li>

  		<li class="game game-top winner"><button class="btn btn-primary btn-md round1 slot5" value="5" style="width:200px; background-color: black"><?php echo $section8->getSecond();?></button> <span></span></li>
  		<li class="game game-spacer">&nbsp;</li>
  		<li class="game game-bottom winner"><button class="btn btn-primary btn-md round1 slot6" value="6" style="width:200px; background-color: black"><?php echo $section8->getSeventh();?></button> <span></span></li>

  		<li class="spacer">&nbsp;</li>
  		<li class="spacer">&nbsp;</li>

  		<li class="game game-top winner"><button class="btn btn-primary btn-md round1 slot7" value="7" style="width:200px; background-color: black"><?php echo $section8->getThird();?></button> <span></span></li>
  		<li class="game game-spacer">&nbsp;</li>
  		<li class="game game-bottom winner"><button class="btn btn-primary btn-md round1 slot8" value="8" style="width:200px; background-color: black"><?php echo $section8->getSixth();?></button> <span></span></li>
